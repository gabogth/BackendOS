        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    Numero = table.Column<int>(type: "int", nullable: false),
                    NumeroDocumentoGen = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    SerieDocumentoGen = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaFianzaFinal = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaFianzaInicio = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaPagoFactura = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaRecepcionFactura = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaRecepcionHES = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaVencimientoFactura = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Id = table.Column<long>(type: "bigint", nullable: false),
                    LicitacionCodigo = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    NumeroFactura = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    NumeroHES = table.Column<int>(type: "int", nullable: false),
                    ReporteCalidad = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ReporteMedicion = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orden_servicio_cabecera_orden_servicio_tipo_OrdenServicioTipoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_orden_trabajo_cabecera_orden_servicio_cabecera_OrdenServicioCabeceraId",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_orden_trabajo_cabecera_orden_trabajo_cabecera_OrdenTrabajoCabeceraPadreId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orden_trabajo_personal_orden_trabajo_cabecera_OrdenTrabajoCabeceraId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_tercero_documento_identidad_tipo_DocumentoIdentidadTipoFinancieroId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrigenFinancieroId = table.Column<short>(type: "smallint", nullable: false),
                    Estado = table.Column<byte>(type: "tinyint", nullable: false),
                    Comentarios = table.Column<string>(type: "nvarchar(max)", maxLength: -1, nullable: true),
                    TerceroGenId = table.Column<int>(type: "int", nullable: false),
                    DocumentoTipoGenId = table.Column<int>(type: "int", nullable: false),
                    SerieDocumentoGen = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    NumeroDocumentoGen = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_orden_servicio_mantenimiento_externo_contrato_cabecera_ActaConformidadId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_orden_servicio_mantenimiento_externo_contrato_cabecera_ContratoCabeceraId",
                        column: x => x.ContratoCabeceraId,
                        principalSchema: "legal",
                        principalTable: "contrato_cabecera",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_orden_servicio_mantenimiento_externo_mantenimiento_tipo_MantenimientoTipoId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_orden_servicio_mantenimiento_externo_orden_servicio_cabecera_Id",
                        column: x => x.Id,
                        principalSchema: "mantto",
                        principalTable: "orden_servicio_cabecera",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_orden_servicio_mantenimiento_externo_persona_ClienteSupervisorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaPago = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DocumentoTipoId = table.Column<int>(type: "int", nullable: false),
                    SerieDocumento = table.Column<string>(type: "nvarchar(4)", maxLength: 4, nullable: true),
                    NumeroDocumento = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_orden_trabajo_detalle_orden_trabajo_cabecera_OrdenTrabajoCabeceraId",
                        column: x => x.OrdenTrabajoCabeceraId,
                        principalSchema: "mantto",
                        principalTable: "orden_trabajo_cabecera",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_financiero_orden_servicio_financiero_detalle_FinancieroDetalleId",
                        column: x => x.FinancieroDetalleId,
                        principalSchema: "finanzas",
                        principalTable: "financiero_detalle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_financiero_orden_servicio_orden_servicio_cabecera_OrdenServicioCabeceraId",
                        column: x => x.OrdenServicioCabeceraId,
                        principalSchema: "mantto",
                        principalTable: "orden_servicio_cabecera",
                        principalColumn: "Id",
