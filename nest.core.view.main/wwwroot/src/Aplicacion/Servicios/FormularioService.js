function FormularioService() {
    this.path = "/security/Formulario"
    ...
    this.ObtenerPorModuloId = async (moduloId) => {
        const respuesta = await client.executeGet(`${this.path}/modulo/${moduloId}`);
        return respuesta;
    };
    ...
    this.ObtenerPorRolId = async (roleId) => {
        const respuesta = await client.executeGet(`${this.path}/rol/${roleId}`);
        return respuesta;
    };
