...
{
    public class CuentaCorrienteRepository : CrudRepositoryBase<CuentaCorriente, int>, ICuentaCorrienteRepository
    {
        ...
        public Task<CuentaCorriente> Agregar(CuentaCorriente entry) => AddAsync(entry);

        public Task<CuentaCorriente> Modificar(CuentaCorriente entry) => UpdateAsync(entry);
