...
{
    public class LicenciaConducirRepository : CachedRepositoryBase<LicenciaConducir, byte>, ILicenciaConducirRepository
    {
        ...
        public Task<LicenciaConducir> Agregar(LicenciaConducir entry) => AddAsync(entry);
        public Task<LicenciaConducir> Modificar(LicenciaConducir entry) => UpdateAsync(entry);
