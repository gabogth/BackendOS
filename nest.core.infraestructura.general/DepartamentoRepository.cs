...
{
    public class DepartamentoRepository : CachedRepositoryBase<Departamento, int>, IDepartamentoRepository
    {
        ...
        public async Task<Departamento> Agregar(Departamento dto) => await AddAsync(dto);
        public async Task<Departamento> Modificar(Departamento dto) => await UpdateAsync(dto);
