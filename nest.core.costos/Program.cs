...
Console.WriteLine("Iniciando aplicación Costos...");
...
builder.Services.AddSwaggerGen(c => {
    ...
    c.SwaggerDoc("v1", new OpenApiInfo {
        ...
        Description = $"La {apiName} permite gestionar los centros de costos de la organización. Con esta API puedes consultar, crear, modificar y eliminar centros de costos.\r\n\r\nTodos los endpoints requieren autorización para acceder.",
