...
{
    public class OrdenServicioCabeceraGenericValidator<TCommand> : AbstractValidator<TCommand>
        where TCommand : IOrdenServicioCabeceraGenericCommand
    {
        public OrdenServicioCabeceraGenericValidator()
        {
