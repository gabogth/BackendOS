...
{
    public class OrdenTrabajoCabeceraGenericValidator<TCommand> : AbstractValidator<TCommand>
        where TCommand : IOrdenTrabajoCabeceraGenericCommand
    {
        public OrdenTrabajoCabeceraGenericValidator()
        {
