...
{
    public class OrdenServicioMantenimientoExternoGenericValidator<TCommand> : AbstractValidator<TCommand>
        where TCommand : IOrdenServicioMantenimientoExternoGenericCommand
    {
        public OrdenServicioMantenimientoExternoGenericValidator()
        {
