...
{
    public class OrdenTrabajoDetalleGenericValidator<TCommand> : AbstractValidator<TCommand>
        where TCommand : IOrdenTrabajoDetalleGenericCommand
    {
        public OrdenTrabajoDetalleGenericValidator()
        {
