...
namespace nest.core.aplicacion.rrhh.HorarioDetalleServices
{
    public class HorarioDetalleService
    {
        ...
        public async Task<HorarioDetalle> Agregar(HorarioDetalleCrearDto entry) => await repository.Agregar(entry);
        public async Task<HorarioDetalle> Modificar(long id, HorarioDetalleCrearDto entry) => await repository.Modificar(id, entry);
