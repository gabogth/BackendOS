...
{
    public class AdjuntoTipoGenericValidator<TCommand> : AbstractValidator<TCommand>
        where TCommand : IAdjuntoTipoGenericCommand
    {
        public AdjuntoTipoGenericValidator()
        {
            RuleFor(x => x.Nombre)
