...
{
    public class AdjuntoConfigProviderGenericValidator<TCommand> : AbstractValidator<TCommand>
        where TCommand : IAdjuntoConfigProviderGenericCommand
    {
        public AdjuntoConfigProviderGenericValidator()
        {
            RuleFor(x => x.Nombre)
