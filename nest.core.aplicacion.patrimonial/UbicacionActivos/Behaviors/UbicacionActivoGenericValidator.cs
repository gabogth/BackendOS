...
{
    public class UbicacionActivoGenericValidator<TCommand> : AbstractValidator<TCommand>
        where TCommand : IUbicacionActivoGenericCommand
    {
        public UbicacionActivoGenericValidator()
        {
